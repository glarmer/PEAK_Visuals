...
public class ConfigurationHandler
{
    ...
    public bool DLSSEnabled => Plugin.Instance.UpscalerLibAvailable && ConfigDLSSMode.Value != (int)PEAK_Visuals.Upscaling.DLSSMode.Off;
    ...
    public ConfigurationHandler(ConfigFile configFile)
    {
        ...
        ConfigDLSSMode = Bind(
            ...
            "DLSSMode",
            0,
            "Controls NVIDIA DLSS, requires an Nvidia RTX GPU! 0 = Off, 1 = Ultra Quality (77%), 2 = Quality (67%), 3 = Balanced (58%), 4 = Performance (50%), 5 = Ultra Performance (33%), 6 = DLAA (100%).",
